...
def test_change_doc_owner():
    ...
    doc.call_method('changeOwner', dict(eitherNewOwnerPubKey=0, orNewOwnerAddress=Address.zero_addr()), expect_ec=DidContractError.MessageSenderIsNotController)
...
def test_change_registry_owner():
    registry.call_method('changeOwner', dict(eitherNewOwnerPubKey=0, orNewOwnerAddress=Address.zero_addr()), expect_ec=DidContractError.MessageSenderIsNotController)
